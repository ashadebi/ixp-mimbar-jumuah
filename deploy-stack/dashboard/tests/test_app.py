...
import tempfile
import sys
os.environ.setdefault('SYSLOG_COLLECTOR_TOKEN','test-collector-token-with-safe-length')
...
class ApplicationTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        os.environ['SYSLOG_COLLECTOR_TOKEN']='test-collector-token-with-safe-length'
